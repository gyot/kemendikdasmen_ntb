    ...
    <div class="">
        <div class="card card-default">
            <div class="card-header with-border">
                <h3 class="card-title">Edit Kliping</h3>
            </div>
            <div class="card-body">
                <form action="{{ url('home/kliping/update') }}" method="POST" role="form" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    {{ method_field('PATCH') }}
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="id_kategori" id="id_kategori" class="form-control" required>
                                            ...
                                            @forelse(\App\Models\KategoriKliping::all() as $kategori)
                                    ...
                                    <div class="form-group">
                                        <label for="">File Kliping</label>
                                        <input type="file" id="kliping" name="kliping" accept=".pdf, image/*">
                                    </div>
                                    <div class="form-group" hidden>
                                        <label for="">Kontent</label>
                                        <textarea class="form-control textarea" id="textarea" required name="content">{{ $data->content }}</textarea>
                                    </div>
