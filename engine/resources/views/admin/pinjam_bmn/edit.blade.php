...
@section('content')
    <div class="">
        <div class="card card-default">
            ...
            <div class="card-body">
                <form action="{{ url('home/slider/update') }}" method="POST" role="form" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    {{ method_field('PATCH') }}
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                          ...
                                          <input type="text" class="form-control" required name="url" value="{{ $data->url }}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                          ...
                                          <input type="text" class="form-control" required name="order" value="{{ $data->order }}">
                                        </div>
                                    </div>
