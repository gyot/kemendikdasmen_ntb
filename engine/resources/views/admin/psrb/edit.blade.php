    ...
    <div class="">
        <div class="card card-default">
            <div class="card-header with-border">
                <h3 class="card-title">Edit Psrb</h3>
            </div>
            <div class="card-body">
                <form action="{{ url('home/psrb/update') }}" method="POST" role="form" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    {{ method_field('PATCH') }}
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="id_kategori" id="id_kategori" class="form-control" required>
                                            ...
                                            @forelse(\App\Models\KategoriPsrb::all() as $kategori)
