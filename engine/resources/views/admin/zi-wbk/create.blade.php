    ...
    <div class="" style="margin-top:10px;">
        <div class="card card-default">
            <div class="card-header with-border">
                <h3 class="card-title">DAFTAR FILE ZI-WBK LPMP NTB</h3>
            </div>
            <div class="card-body">
                <form action="{{ url('home/zi-wbk') }}" method="POST" role="form" enctype="multipart/form-data">
                        {{ csrf_field() }}
                    <div class="row">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="id_kategori" id="id_kategori" class="form-control" required>
                                            ...
                                            @forelse(\App\Models\KategoriZiwbk::all() as $kategori)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="file" onchange="loadFile2(this)">
                                        <div>
                                            <img src="" id="pic2" style="max-width: 200px;">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="">Konten</label>
                                        <textarea class="form-control textarea" required name="content" value=".">{{ old('content') }}</textarea>
                                    </div>
                                    <div class="form-group">
