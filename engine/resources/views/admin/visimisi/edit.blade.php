...
@section('content')
    <div class="">
        <div class="card card-default">
            ...
            <div class="card-body">
                <form action="{{ url('home/visimisi/update') }}" method="POST" role="form" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    {{ method_field('PATCH') }}
                            ...
                            <div class="card card-default">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {{ Form::select('kategori', [''=>'Kategori'] + \App\Models\HelperData::kategori_visimisi(), $data->kategori,['class'=>'form-control js-select', 'required'=>true])}}
                                    </div>
                                    <div class="form-group">
